  ...
  render() {
    return(
      <article>
        ...
        <div>
          <p>
            <strong>Headers</strong> and <strong>Footers</strong> are the most common
            things that you will see in websites nowadays. To automatically add it to
            your page once you have built the components for <strong>header</strong> and&nbsp;
            <strong>footer</strong> follow the steps below:
          </p>
...
`} />
            ...
            <li className="mt-4">
              6) Edit <i>`src/routes.js`</i> and add route for home page.
